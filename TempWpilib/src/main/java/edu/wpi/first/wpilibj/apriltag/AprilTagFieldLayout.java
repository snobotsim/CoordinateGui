...
//  }
  ...
  public void serialize(Path path) throws IOException {
    new ObjectMapper().enable(SerializationFeature.INDENT_OUTPUT).writeValue(path.toFile(), this);

    String xxxx = new ObjectMapper().enable(SerializationFeature.INDENT_OUTPUT).writeValueAsString(this);
//    mapper.enable(SerializationFeature.INDENT_OUTPUT);
    System.out.println(xxxx);
  }

  public static AprilTagFieldLayout fromFile(Path path) throws IOException {
    return new ObjectMapper().readValue(path.toFile(), AprilTagFieldLayout.class);
  }
  ...
  public static AprilTagFieldLayout fromField(AprilTagFields field) throws IOException {
    return fromResource(field.m_resourceFile);
  }
