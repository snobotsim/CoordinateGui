...
import org.snobot.coordinate_gui.shuffleboard.charged_up.data.ChargedUpCoordinateGuiDataType;
...
@Description(group = "org.snobot.coordinate_gui", name = "CoordinateGuiPlugins2023", version = PluginVersion.VERSION, summary = "Coordinate GUI Utilities")
public class ShuffleboardPlugin2023 extends Plugin
{
    ...
    public List<ComponentType> getComponents()
    {
        return ImmutableList.of(
                WidgetType.forAnnotatedWidget(ChargedUpCoordinateGuiWidget.class),
    ...
    {
        return ImmutableList.of(
                ChargedUpCoordinateGuiDataType.INSTANCE,
