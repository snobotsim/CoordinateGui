package org.snobot.coordinate_gui.gen;
...
public final class Main
{
    public static class PseudoMain extends Application
    {
        ...
        {
            // Pane root =
            // FXMLLoader.load(getClass().getResource("/org/snobot/coordinate_gui/gen/trajectory/ui/trajectory_gen_controller.fxml"));
            Pane root = FXMLLoader.load(getClass().getResource("/org/snobot/coordinate_gui/gen/pure_pursuit/ui/pure_pursuit_gen_controller.fxml"));
