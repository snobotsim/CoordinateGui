package org.snobot.coordinate_gui.game.charged_up;
...
public final class StandaloneMain
{
    public static class PseudoMain extends Application
    {
        ...
        {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("charged_up_field.fxml"));
            Pane root = loader.load();
            ChargedUpController robotController = loader.getController();
