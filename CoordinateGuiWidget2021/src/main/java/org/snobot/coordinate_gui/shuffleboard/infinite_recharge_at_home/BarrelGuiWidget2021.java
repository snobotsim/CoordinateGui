...
@ParametrizedController("BarrelGuiWidget.fxml")
public class BarrelGuiWidget2021 extends BaseCoordinateGuiWidget<InfiniteRechargeAtHomeCoordinateGuiData, InfiniteRechargeAtHomeController>
{
    @FXML
    protected BarrelController mFieldController;

    public BarrelGuiWidget2021()
    {
